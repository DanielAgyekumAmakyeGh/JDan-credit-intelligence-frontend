"""
Credit Intelligence Bureau - Complete Dashboard with ML Model Training
"""
...
# ============================================================
    ...
    **Stacked Ensemble Architecture:**
    ...
    st.markdown("""
    - **High Recall (96.7%)**: The model catches 97% of actual defaults - excellent for loss prevention
    - **Moderate Precision (51.3%)**: About half of flagged cases are true defaults - acceptable for lending
...
# ============================================================
    ...
    if st.session_state.borrower_id:
        ...
        # Show borrower features used for prediction
        borrower = api_get(f"/borrowers/{st.session_state.borrower_id}")
        if borrower:
...
# ============================================================
    ...
    if lenders:
        high_risk = []
        for l in lenders:
            rate = safe_float(l.get('default_rate', 0))
            if rate > 20:
                high_risk.append(l)
        if high_risk:
